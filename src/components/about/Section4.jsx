        ...
        <div className='timeline-section w-full  h-[100vh] flex sm:flex-col-reverse'>
            <div className='sm:w-full w-[42%] sm:h-[28vh]  h-full  flex flex-col justify-end'>
                <div className='w-full h-[72vh] pl-[2.5vw] pb-[1vw] flex flex-col justify-between'>
                    <div className='sm:h-[17vw] h-[10vw] w-fit overflow-hidden '>
                        ...
                        <h1 className='present-year sm:text-[16vw] text-[10vw] font-semibold leading-none'>1994</h1>
                    ...
                    <div className='w-full h-[60%] flex flex-col justify-end sm:mb-[10vw]'>
                        ...
                        <div className="w-full relative h-[40%]">
                            <p className="timeline-para1 absolute w-[90%] sm:text-[4.5vw] text-[1vw] leading-tight text-[#80868B]">
                            ...
                            <p className="timeline-para2 opacity-0 absolute w-[90%] sm:text-[4.5vw] text-[1vw] leading-tight text-[#80868B]">
                            ...
                            <p className="timeline-para3 opacity-0 absolute w-[90%] sm:text-[4.5vw] text-[1vw] leading-tight text-[#80868B]">
                                The advancements in excavation technology allowed researchers to uncover artifacts that were previously inaccessible.
                            </p>
                            <p className="timeline-para4 opacity-0 absolute w-[90%] sm:text-[4.5vw] text-[1vw] leading-tight text-[#80868B]">
                                Local legends spoke of a hidden treasure buried beneath the hills, sparking curiosity and exploration for centuries.
                            </p>
                            <p className="timeline-para5 opacity-0 absolute w-[90%] sm:text-[4.5vw] text-[1vw] leading-tight text-[#80868B]">
                                Geological surveys showed evidence of a rare mineral deposit, attracting mining companies to the area in the early 1900s.
                            </p>
                            <p className="timeline-para6 opacity-0 absolute w-[90%] sm:text-[4.5vw] text-[1vw] leading-tight text-[#80868B]">
            ...
            <div className='sm:w-full w-[57%] relative sm:h-fit sm:px-[4vw]'>
                <div className='sm:h-fit h-[28vh] flex flex-col justify-end pb-[1vw]'>
                    <div>
                        <h2 className='sm:text-[10vw] text-[3vw] font-semibold sm:mb-[2vw] mb-[1vw] capitalize'>Our history</h2>
                        <p className='sm:w-[85%] w-[70%] sm:text-[4.5vw] text-[1.2vw] leading-tight text-[#80868B] sm:mb-[4vw]'>ZCMC, and the Kajaran deposit, has a long standing history with animportant role in the development of the country and the region.</p>
                    </div>
                </div>
                <div className='w-full sm:h-[37vh]  h-[72vh] flex justify-between items-end pb-[1vw] sm:pb-[2vw] sm:mt-[15vw]'>
                    ...
                    <div className='sm:w-full w-[89%] sm:h-[85%] h-full relative rounded-lg overflow-hidden'>
