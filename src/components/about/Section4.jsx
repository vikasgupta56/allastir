                ...
                <div className='w-full h-[72vh] pl-[2.5vw] pb-[1vw] flex flex-col justify-between'>
                    ...
                    <div className='w-full h-[60%] flex flex-col justify-end sm:mb-[10vw]'>
                        <div className='sm:h-[8.5vw] h-[4.5vw] w-fit overflow-hidden sm:mb-[3vw]'>
                            ...
                            <h2 className='timeline-title leading-1 sm:text-[6vw] text-[3vw] capitalize'>Innovate Solutions</h2>
                            <h2 className='timeline-title leading-1 sm:text-[6vw] text-[3vw] capitalize'>Execute Efficiently</h2>
                            <h2 className='timeline-title leading-1 sm:text-[6vw] text-[3vw] capitalize'>Achieve Goals</h2>
