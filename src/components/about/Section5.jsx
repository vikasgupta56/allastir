...
const Section5 = () => {
  return (
    <div className='px-[2.5vw] flex sm:flex-col-reverse justify-between w-full min-h-screen py-[8vw] gap-[.5vw]'>
      ...
      <div className='w-full h-[100vh] '>
        <div className="w-full h-[40%]  flex flex-col justify-between pr-[5vw] sm:pb-[5vw] pb-[1.2vw]">
        ...
        <div className="w-full h-[60%] bg-zinc-200 rounded-md overflow-hidden">
