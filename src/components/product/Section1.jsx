...
const Section1 = () => {
  return (
    <div className='relative w-full h-[60vh] flex flex-col items-center justify-center text-[15vw] font-bold uppercase'>
      ...
      <div className='w-full h-full absolute top-0 left-0 flex items-center justify-center bg-black/50'>
        <h1 className='text-[4vw] text-white'>Our Product</h1>
      </div>
    </div>
  )
}
