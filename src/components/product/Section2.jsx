...
const Section2 = ({ title }) => {
    return (
        <div className='w-full sm:min-h-[30vh] min-h-screen p-[2.5vw] sm:px-0 pt-[5vw]'>
            <h1 className='sm:text-[10vw] text-[3vw] font-semibold capitalize sm:mb-[5vw] mb-[2.5vw] text-centern leading-tight text-center'>{title}</h1>
            <div className='sm:w-[92%] w-[80%] mx-auto rounded-2xl overflow-hidden border border-black/20'>
                {[0, 1, 2, 3, 4, 5].map((p, i) => (<div key={i} className='product-wraper w-full sm:h-[20vw] h-[6vw] flex justify-end border-b border-black/20'>
                    ...
                    <div className='product-txt w-[100%] full flex items-center sm:px-[4vw] px-[2vw] justify-between  shrink-0  transition-all duration-500'>
                       ...
                       <div className='flex flex-col'>
                            <h2 className='sm:text-[4.5vw] text-[1.5vw] capitalize leading-none mb-[.2vw]'>Orange pills</h2>
                        </div>
                        <div className='num-c sm:px-[4vw]  px-[1.2vw] sm:py-[.5vw] py-[.2vw] rounded-full bg-black text-white sm:text-[3vw] text-[.7vw] font-semibold transition-all duration-300 relative'>
                        <h2 className='num transition-all duration-300'>{p+1}</h2>
                        <i className="ri-arrow-right-line sm:text-[3vw] text-[.7vw] absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-black transition-all duration-300 opacity-0"></i>
                        </div>
                       </div>
                    </div>
                </div>))}
