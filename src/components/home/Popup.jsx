...
const Popup = ({ popup }) => {
  ...
  return (
    <div className='w-full h-screen absolute top-0 left-0 pointer-events-none'>
      <div ref={popup} className="notification pointer-events-auto fixed scale-0 z-10 border sm:bottom-[5vw] bottom-[2vw] sm:right-[4vw] md:right-[4vw] lg:right-[4vw] right-[2vw] sm:w-[90%] md:w-[90%] lg:w-[70%] lg:w-[90%] w-[20%] sm:p-[4vw] md:p-[4vw] lg:p-[4vw] p-[1vw] bg-white rounded-xl flex items-start justify-between sm:gap-[3vw] md:gap-[3vw] lg:gap-[3vw] gap-[1vw]">
