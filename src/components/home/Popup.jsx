  ...
  return (
    <div className='w-full h-screen absolute top-0 left-0 pointer-events-none'>
      <div ref={popup} className="notification pointer-events-auto fixed scale-0 z-10 border sm:bottom-[5vw] bottom-[2vw] sm:right-[4vw] right-[2vw] sm:w-[90%] w-[20%] sm:p-[4vw] p-[1vw] bg-white rounded-xl flex items-start justify-between sm:gap-[3vw] gap-[1vw]">
        <div className='sm:p-[3vw] p-[1vw] sm:px-[4vw] px-[1.3vw] rounded-lg bg-blue-950/10 text-[#1863AB] flex items-center justify-center'>
        ...
        <div>
          ...
          <button className='text-white bg-[#1863AB] hover:bg-[#1864abea] sm:text-[3vw] text-[.6vw] font-regular sm:px-[4vw] px-[.9vw] sm:py-[1.5vw] py-[.4vw] sm:mt-[1.5vw] mt-[.7vw] rounded-full'>Register Now</button>
        </div>
        <div onClick={() => {
      ...
      }} className='sm:w-[12vw] w-[2.8vw] opacity-0 sm:h-[12vw] h-[2.8vw] rounded-full bg-[#1863AB] hover:bg-[#1864abeb]  fixed z-10 sm:bottom-[5vw] bottom-[2vw] sm:right-[4vw] right-[2vw] pointer-events-auto cursor-pointer flex items-center justify-center'>
