...
const Popup = ({setisOpen ,popup}) => {
  return (
    ...
    <div onClick={()=>setisOpen(false)} className="close  scale-0 cursor-pointer absolute right-[.5vw] top-[.5vw] rounded-full bg-black/10 hover:bg-black/20  w-[1.5vw] h-[1.5vw] flex items-center justify-center"><i className="ri-close-line"></i></div>
  </div>
