...
const Footer = () => {
  return (
    <div className='w-full sm:h-[52vh] h-[55vh]  p-[4vw] sm:p-[4vw] px-[2.5vw]'> 
      <div className='w-full h-full flex sm:flex-col sm:justify-between'>
        ...
        <div className='sm:w-full w-1/2 sm:h-fit h-full sm:text-[4vw] flex sm:flex-wrap sm:mt-[10vw] capitalize sm:justify-between'>
