...
const Footer = () => {
  return (
    <div className='w-full sm:h-[75vh] h-[55vh]  p-[4vw] sm:p-[4vw] px-[2.5vw] sm:pb-[5vw]'>
      <div className='w-full h-full flex sm:flex-col sm:justify-between'>
        ...
        <div className='sm:w-full w-1/2 h-full flex sm:flex-col sm:mt-[10vw] capitalize sm:justify-between'>
        <div className='sm:w-full w-[33.3%]  sm:h-fit  h-full flex flex-col sm:gap-[4vw]  justify-between'>
        <h2>product</h2>
