...
const Navbar = () => {
  ...
  return (
    <div className='w-full  sm:px-[4vw] md:px-[4vw] px-[2.5vw] sm:py-[3.1vw] md:py-[3.1vw] py-[1vw] text-black bg-white flex items-center justify-between fixed z-[9] top-0 left-0'>
      <Image width={1000} height={1000} className='w-[200px] h-auto' src="/logo-with-tag.png" alt='logo' />
      <div className='sm:hidden md:hidden absolute top-1/2  left-1/2 -translate-x-1/2 text-[1.1vw] font-regular capitalize -translate-y-1/2 flex items-center gap-[3vw]'>
      ...
      <i onClick={openSidebar} className="menu-icon cursor-pointer ri-menu-fill text-[5.5vw] sm:block md:block hidden font-semibold"></i>
      <div className='side-menu duration-300 w-[100%] h-[100vh] absolute top-[-100vh] left-0 text-black sm:flex md:flex hidden justify-end uppercase font-semibold text-left text-[6vw]'>
